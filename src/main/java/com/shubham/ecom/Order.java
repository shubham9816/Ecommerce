...
//    private SimpleIntegerProperty quantity;
    ...
    public Order(String name, int id, int quantity, Date order_date, String order_status) {
    ...
    public static ObservableList<Order> getAllOrders (int customerId){
        String selectOrderQuery = "SELECT product.name, orders.id, orders.quantity, order_date, order_status FROM orders join product on product_id = product.id WHERE customer_id="+customerId+";";
